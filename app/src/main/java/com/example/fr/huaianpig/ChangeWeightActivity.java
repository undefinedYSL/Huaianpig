...
/**
 * Created by FR on 2017/7/11.
 */
public class ChangeWeightActivity extends AppCompatActivity {
    private Button query;
    private String mResponse;
//    private String path = "http://192.168.43.235:8888/myApps";4
//    public String path = "http://192.168.43.222:9999/myApps";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.changeweight_layout);
        ...
        title_set_bn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intent.setClass(ChangeWeightActivity.this, PigmanageActivity.class);
                startActivity(intent);
                finish();
            }
        });
        changeweight = (EditText)findViewById(R.id.changeweight);
            ...
            new Thread() {
                ...
                public void run() {
                    mResponse = GetPostUtil.sendPost(
                            path.getIp(), "updatepigweight"+"@"+pigid_tv.getText()+"@"+changeweight.getText()+"@");
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 0x456) {
                ...
                if (mResponse.equals("success") ){
                    Toast.makeText(ChangeWeightActivity.this, "发送成功", Toast.LENGTH_SHORT).show();
                }else {
                    Toast.makeText(ChangeWeightActivity.this, "发送失败", Toast.LENGTH_SHORT).show();
                }
            }
        }
    };
