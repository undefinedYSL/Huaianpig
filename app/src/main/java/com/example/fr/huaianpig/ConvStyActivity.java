 ...
 */
public class ConvStyActivity extends Activity {
    ...
    private TextView forepigsty;
    private TextView laterpigsty;
    private EditText laterpigsty_et;
...
//    private String path = "http://192.168.43.222:9999/myApps";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.convpigsty_layout);
        ...
        title_set_bn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intent.setClass(ConvStyActivity.this, PigmanageActivity.class);
        ...
        laterpigsty = (TextView) findViewById(R.id.laterpigsty);
        laterpigsty_et = (EditText) findViewById(R.id.laterpigsty_et);
            ...
            new Thread() {
                ...
                public void run() {
                    mResponse = GetPostUtil.sendPost(
                            path.getIp(), "changepiglocation"+"@"+pigid_tv.getText()+"@"+laterpigsty_et.getText()+"@");
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 0x456) {
                ...
                if (mResponse.equals("success")){
                    Toast.makeText(ConvStyActivity.this, "发送成功", Toast.LENGTH_SHORT).show();
                }else {
                    Toast.makeText(ConvStyActivity.this, "请检查是否已录入该猪只编号", Toast.LENGTH_SHORT).show();
                }
            }
        }
    };
