 ...
 */
public class PigDeathActivity extends Activity {
...
//    private String path = "http://192.168.43.222:9999/myApps";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pigdeath_layout);
        ...
        title_set_bn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intent.setClass(PigDeathActivity.this, PigmanageActivity.class);
            ...
            new Thread() {
                ...
                public void run() {
                    mResponse = GetPostUtil.sendPost(
                            path.getIp(), "pigisdead"+"@"+pigid_tv.getText()+"@");
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 0x456) {
                ...
                if (mResponse.equals("success")){
                    Toast.makeText(PigDeathActivity.this, "发送成功", Toast.LENGTH_SHORT).show();
                }else {
                    Toast.makeText(PigDeathActivity.this, "发送失败", Toast.LENGTH_SHORT).show();
                }
            }
        }
    };
