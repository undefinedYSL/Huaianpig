 ...
 */
//销售信息
public class SickPigInfoActivity extends Activity {
...
//    private String path = "http://192.168.43.222:9999/myApps";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sickpiginfo_layout);
        ...
        title_set_bn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intent.setClass(SickPigInfoActivity.this, SystemActivity.class);
        ...
        new Thread() {
            @Override
            public void run() {
                mResponse = GetPostUtil.sendPost(path.getIp(), "getsellpiginfo@");
            ...
            if (msg.what == 0x123) {
                ...
                list = new ArrayList<>();
                    ...
                    if (arr.length>=1){
                        ...
                        MyBaseAdaptersick myBaseAdapter = new MyBaseAdaptersick(list,SickPigInfoActivity.this);
                        listView.setAdapter(myBaseAdapter);
                    }else {
                        Toast.makeText(SickPigInfoActivity.this,"数据库为空",Toast.LENGTH_SHORT).show();
                    }
            }
        }
    };
    ...
    protected void dialog()
    {
        Dialog dialog = new AlertDialog.Builder(this).setTitle("智能猪场管理终端").setMessage(
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                dialog.dismiss();
                SickPigInfoActivity.this.finish();
            }
